...
const GetUserTable = ()=>{
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "GetUserTable.useEffect": ()=>{
            const fetchData = {
                "GetUserTable.useEffect.fetchData": async ()=>{
                    try {
                        const token = localStorage.getItem('token');
                        if (!token) return;
                        const userData = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$app$2f$api$2f$getuserdetails$2f$userdetails$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["getUsers"])(token);
                        setUsers(userData);
                    } catch (error) {
                        console.error('Error fetching users:', error);
                    }
                }
            }["GetUserTable.useEffect.fetchData"];
            fetchData();
        }
    }["GetUserTable.useEffect"], []);
    // ✅ Search filter
    ...
    const columns = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useMemo"])({
        "GetUserTable.useMemo[columns]": ()=>[
                ...
                },
                {
                    ...
                    cell: {
                        "GetUserTable.useMemo[columns]": ({ row })=>row.original.image ? /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$image$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"], {
                                width: 48,
                                height: 48,
                ...
                },
                {
                    ...
                    cell: {
                        "GetUserTable.useMemo[columns]": ({ row })=>/*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("button", {
                                onClick: {
                                    "GetUserTable.useMemo[columns]": ()=>router.push(`/user/${row.original.id}`)
                                }["GetUserTable.useMemo[columns]"],
...
//# sourceMappingURL=_eb3f113b._.js.map