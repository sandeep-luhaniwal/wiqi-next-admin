...
function ProCategoryTable() {
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "ProCategoryTable.useEffect": ()=>{
            const fetchProCategories = {
                "ProCategoryTable.useEffect.fetchProCategories": async ()=>{
                    try {
                        setLoading(true);
                        const token = localStorage.getItem("token");
            ...
            }["ProCategoryTable.useEffect.fetchProCategories"];
            fetchProCategories();
        }
    }["ProCategoryTable.useEffect"], [
        refreshFlag
...
//# sourceMappingURL=_3cb02467._.js.map