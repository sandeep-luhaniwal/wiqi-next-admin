...
"[project]/app/(protected)/components/stream-category/stream-category-context.js [app-ssr] (ecmascript)": ((__turbopack_context__) => {
"use strict";
...
;
;
const StreamCategoryContext = /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["createContext"])();
const StreamCategoryProvider = ({ children })=>{
    const [streamCategories, setStreamCategories] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useState"])([]);
    const [streamCategoryToEdit, setStreamCategoryToEdit] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useState"])(null);
    ...
    return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])(StreamCategoryContext.Provider, {
        value: {
            streamCategories,
            setStreamCategories,
...
const useStreamCategory = ()=>(0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useContext"])(StreamCategoryContext);
}}),
"[project]/app/api/categories/streamcategories.js [app-ssr] (ecmascript)": ((__turbopack_context__) => {
"use strict";
...
var __TURBOPACK__imported__module__$5b$project$5d2f$app$2f28$protected$292f$components$2f$stream$2d$category$2f$stream$2d$category$2d$context$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/app/(protected)/components/stream-category/stream-category-context.js [app-ssr] (ecmascript)");
...
var __TURBOPACK__imported__module__$5b$project$5d2f$app$2f$api$2f$categories$2f$streamcategories$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/app/api/categories/streamcategories.js [app-ssr] (ecmascript)");
"use client";
;
;
;
...
const CreateStreamCategory = ()=>{
    ...
    const { streamCategoryToEdit, triggerRefresh, setStreamCategoryToEdit } = (0, __TURBOPACK__imported__module__$5b$project$5d2f$app$2f28$protected$292f$components$2f$stream$2d$category$2f$stream$2d$category$2d$context$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useStreamCategory"])();
    ...
    const handleSubmit = async (e)=>{
        ...
        try {
            ...
            let data;
            if (streamCategoryToEdit) {
                data = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$app$2f$api$2f$categories$2f$streamcategories$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["updateStreamCategory"])(token, streamCategoryToEdit._id, name);
            } else {
                data = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$app$2f$api$2f$categories$2f$streamcategories$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["createStreamCategory"])(token, name);
            }
            __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$react$2d$hot$2d$toast$2f$dist$2f$index$2e$mjs__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["default"].success(data.message || "Stream category saved successfully!");
            triggerRefresh();
            resetForm();
            setOpen(false);
        } catch (err) {
...
"[project]/app/(protected)/components/stream-category/StreamCategoryTabel.jsx [app-ssr] (ecmascript)": ((__turbopack_context__) => {
"use strict";
...
const StreamCategoryTable = ()=>{
    const { streamCategories, setStreamCategories, refreshFlag, setStreamCategoryToEdit } = (0, __TURBOPACK__imported__module__$5b$project$5d2f$app$2f28$protected$292f$components$2f$stream$2d$category$2f$stream$2d$category$2d$context$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useStreamCategory"])();
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useEffect"])(()=>{
        const fetchCategories = async ()=>{
            try {
                setLoading(true);
                const token = localStorage.getItem("token");
                const data = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$app$2f$api$2f$categories$2f$streamcategories$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["getStreamCategories"])(token);
    ...
    const filteredData = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useMemo"])(()=>{
        ...
        return streamCategories.filter((cat)=>cat.name?.toLowerCase().includes(searchQuery.toLowerCase()));
    }, [
        searchQuery,
        streamCategories
    ]);
...
//# sourceMappingURL=_aefbadc4._.js.map