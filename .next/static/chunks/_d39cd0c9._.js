...
;
;
function ProCreateCategory({ triggerRefresh, productToEdit }) {
    _s();
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "ProCreateCategory.useEffect": ()=>{
            if (productToEdit) {
                ...
                setUrl(productToEdit.url || "");
                setType(productToEdit.type || "");
                setCategoryId(productToEdit.categoryId?._id || "");
                setSubCategoryId(productToEdit.subCategoryId?._id || "");
    ...
    const handleSubmit = async ()=>{
        ...
        try {
            ...
            const endpoint = productToEdit?._id ? "https://wiqiapi.testenvapp.com/api/admin/updateProSubCategory" // update API
             : "https://wiqiapi.testenvapp.com/api/admin/proSubCategory"; // create API
...
_s(ProCreateCategory, "Bd9/pXIsotWxSUdAnsI+FcmBf9g=");
...
_s(ProCategoryProvider, "HHFtHXcw56Vgc/Snm3LxKWqA6oQ=");
...
function ProCategoryTable() {
    _s();
    const { proCategories, setProCategories, setProCategoryToEdit, refreshFlag } = (0, __TURBOPACK__imported__module__$5b$project$5d2f$app$2f28$protected$292f$components$2f$category$2f$pro$2d$category$2f$pro$2d$category$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useProCategory"])();
            ...
            const fetchProCategories = {
                "ProCategoryTable.useEffect.fetchProCategories": async ()=>{
                    try {
                        ...
                        const data = await res.json();
                        if (data.success) {
                            setProCategories(data.data.data || []);
                        }
                    } catch (err) {
                        console.error(err);
                    } finally{
    ...
    const filteredData = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useMemo"])({
        "ProCategoryTable.useMemo[filteredData]": ()=>{
            ...
            return proCategories.filter({
                "ProCategoryTable.useMemo[filteredData]": (item)=>item.title?.toLowerCase().includes(searchQuery.toLowerCase()) || item.type?.toLowerCase().includes(searchQuery.toLowerCase()) || item.categoryId?.name?.toLowerCase().includes(searchQuery.toLowerCase())
            }["ProCategoryTable.useMemo[filteredData]"]);
        }
    }["ProCategoryTable.useMemo[filteredData]"], [
        searchQuery,
    ...
    const columns = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useMemo"])({
        "ProCategoryTable.useMemo[columns]": ()=>[
                ...
                },
                {
                    id: "createdAt",
                    accessorFn: {
                        "ProCategoryTable.useMemo[columns]": (row)=>row.createdAt
                    }["ProCategoryTable.useMemo[columns]"],
                    header: "Created At",
                    cell: {
                        "ProCategoryTable.useMemo[columns]": ({ row })=>new Date(row.original.createdAt).toLocaleDateString()
                    }["ProCategoryTable.useMemo[columns]"]
                },
                {
                    id: "actions",
                    ...
                    cell: {
                        "ProCategoryTable.useMemo[columns]": ({ row })=>/*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                ...
                                children: [
                                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("button", {
                                        onClick: {
                                            "ProCategoryTable.useMemo[columns]": ()=>setProCategoryToEdit(row.original)
                                        }["ProCategoryTable.useMemo[columns]"],
...
_s(ProCategoryTable, "f3cawhS1rInjtlSr+Cox3+vz5z4=", false, function() {
    return [
...
//# sourceMappingURL=_d39cd0c9._.js.map