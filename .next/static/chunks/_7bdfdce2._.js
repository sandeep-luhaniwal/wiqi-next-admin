...
const CreateStreamCategory = ()=>{
    ...
    const handleSubmit = async (e)=>{
        e.preventDefault();
        try {
            const res = await fetch("/api/admin/streamCategory", {
                method: "POST",
                headers: {
            ...
            if (res.ok) {
                toast({
                    title: "Success",
                    description: "Stream category created successfully!"
                });
                setName("");
            } else {
                toast({
...
_s(CreateStreamCategory, "gFPpQ6rgfiGkmgRsh4q2nIO1W+Q=");
...
//# sourceMappingURL=_7bdfdce2._.js.map