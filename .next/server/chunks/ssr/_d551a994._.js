...
"[project]/app/(protected)/components/home/GetUserTabel.jsx [app-ssr] (ecmascript)": ((__turbopack_context__) => {
"use strict";
...
const GetUserTable = ()=>{
    ...
    const filteredData = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useMemo"])(()=>{
        ...
        return users.filter((u)=>u.firstName?.toLowerCase().includes(searchQuery.toLowerCase()) || u.lastName?.toLowerCase().includes(searchQuery.toLowerCase()) || u.userName?.toLowerCase().includes(searchQuery.toLowerCase()) || (u.phone ? String(u.phone).includes(searchQuery) : false));
    }, [
        searchQuery,
        users
    ]);
...
//# sourceMappingURL=_d551a994._.js.map