...
const CreateStreamCategory = ()=>{
    ...
    const handleSubmit = async (e)=>{
        ...
        try {
            ...
            if (res.ok) {
                __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$react$2d$hot$2d$toast$2f$dist$2f$index$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"].success(data.message || "Stream category created successfully!");
                setName("");
            } else {
                __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$react$2d$hot$2d$toast$2f$dist$2f$index$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"].error(data.message || "Failed to create category.");
            }
        } catch (err) {
...
_s(CreateStreamCategory, "b6YtcHgdEGD1oQUpHk75+4UrKwA=");
...
_s(StreamCategoryTable, "h53bi5h0ATgaZgbltYQ/LxsmSWc=", false, function() {
    return [
...
//# sourceMappingURL=_653db386._.js.map