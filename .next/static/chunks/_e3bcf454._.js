...
const CreateStreamCategory = ()=>{
    ...
    const { streamCategoryToEdit, triggerRefresh, setStreamCategoryToEdit } = (0, __TURBOPACK__imported__module__$5b$project$5d2f$app$2f28$protected$292f$components$2f$stream$2d$category$2f$stream$2d$category$2d$context$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useStreamCategory"])();
    ...
    const handleSubmit = async (e)=>{
        ...
        try {
            ...
            let data;
            if (streamCategoryToEdit) {
                data = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$app$2f$api$2f$categories$2f$categories$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["updateStreamCategory"])(token, streamCategoryToEdit._id, name);
            } else {
                data = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$app$2f$api$2f$categories$2f$categories$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["createStreamCategory"])(token, name);
            }
...
_s(CreateStreamCategory, "lVwqEf1kux9EoDOiNFRxqaLUFuc=", false, function() {
    return [
            ...
            const fetchCategories = {
                "StreamCategoryTable.useEffect.fetchCategories": async ()=>{
                    try {
                        setLoading(true);
                        const token = localStorage.getItem("token");
                        const data = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$app$2f$api$2f$categories$2f$categories$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["getStreamCategories"])(token);
...
//# sourceMappingURL=_e3bcf454._.js.map