...
const CreateStreamCategory = ()=>{
    ...
    const handleSubmit = async (e)=>{
        ...
        try {
            ...
            let data;
            if (streamCategoryToEdit) {
                data = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$app$2f$api$2f$categories$2f$categories$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["updateStreamCategory"])(token, streamCategoryToEdit._id, name);
            } else {
                data = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$app$2f$api$2f$categories$2f$categories$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["createStreamCategory"])(token, name);
            }
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useEffect"])(()=>{
        const fetchCategories = async ()=>{
            try {
                setLoading(true);
                const token = localStorage.getItem("token");
                const data = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$app$2f$api$2f$categories$2f$categories$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["getStreamCategories"])(token);
...
//# sourceMappingURL=_359f7159._.js.map