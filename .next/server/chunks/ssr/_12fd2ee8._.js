...
"[project]/app/(protected)/components/post/PostTable.jsx [app-ssr] (ecmascript)": ((__turbopack_context__) => {
"use strict";
...
function PostTable() {
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useEffect"])(()=>{
        const fetchPostsData = async ()=>{
            try {
                ...
                const data = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$app$2f$api$2f$categories$2f$streamcategories$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["getPosts"])(token);
                setPosts(data);
            } catch (err) {
    ...
    const filteredData = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useMemo"])(()=>{
        ...
        return posts.filter((post)=>post.title?.toLowerCase().includes(searchQuery.toLowerCase()) || post.type?.toLowerCase().includes(searchQuery.toLowerCase()) || post.user?.firstName?.toLowerCase().includes(searchQuery.toLowerCase()) || post.user?.lastName?.toLowerCase().includes(searchQuery.toLowerCase()));
    }, [
        searchQuery,
        posts
    ]);
...
//# sourceMappingURL=_12fd2ee8._.js.map